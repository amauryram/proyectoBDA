...
-- Author :       amaury
--
-- Date Created : Tuesday, June 07, 2022 13:05:54
...
ALTER TABLE PUNTAJE_INVERSIONISTA ADD CONSTRAINT RefVOTO_INVERSIONISTA37 
...
ALTER TABLE VOTO_INVERSIONISTA ADD CONSTRAINT RefINVERSIONISTA13 
    FOREIGN KEY (USUARIO_ID)
    REFERENCES INVERSIONISTA(USUARIO_ID)
;

ALTER TABLE VOTO_INVERSIONISTA ADD CONSTRAINT RefPRESTAMO14 
    FOREIGN KEY (PRESTAMO_ID)
    REFERENCES PRESTAMO(PRESTAMO_ID)
;
